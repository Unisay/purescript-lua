...
local Control_Apply_I_apply = function(dict) return dict.apply end
...
local Control_Applicative_I_liftA1 = function(dictApplicative)
  return function(f)
    return function(a)
      return Control_Apply_I_apply(dictApplicative.Apply0(Prim_I_undefined))(Control_Applicative_I_pure(dictApplicative)(f))(a)
    end
  end
end
...
local Prelude_I_pass = function(dictApplicative)
